...
/* Constructor */
CalibrationViewerWidget::CalibrationViewerWidget(QString path, QString n) :
    fullPath(path+"/"+n), name(n), view(0), textEditable(false), combinations(),
    showFailedBool(true), showUselessBool(false), columnSort(1),
    comboSort(false), combinationsInitialised(false){
