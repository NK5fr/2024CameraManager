    ...
    : AbstractCameraManager()
{
	...
	prop.push_back(CameraProperty(CameraManager::BRIGHTNESS, 0, 255.000, 3, false));   
    prop.push_back(CameraProperty(CameraManager::GAIN, 0, (float) 12.041, 3, false));
    prop.push_back(CameraProperty(CameraManager::EXPOSURE, 0, 62.000, 3, false));
    prop.push_back(CameraProperty(CameraManager::GAMMA, 0, 1, 3, false));
    prop.push_back(CameraProperty(CameraManager::SHUTTER, 0, (float) 512.000, 3, false));
