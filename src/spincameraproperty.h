/**
 * \file SpinCameraProperty.h
 * \author Virgile Wozny
 */
#ifndef SpinCameraProperty_H
#define SpinCameraProperty_H

#include <string>
#include <cmath>
#include <QString>

namespace CameraManagerSpin {
	...
	public:
         ...
         */
        SpinCameraProperty(PropertyType type, QString name, double min, double max, int decimals = 0, bool canAuto = false, bool isAuto = true, bool onOff = true, double value = 0);  // Lars Aksel 29.01.2015
